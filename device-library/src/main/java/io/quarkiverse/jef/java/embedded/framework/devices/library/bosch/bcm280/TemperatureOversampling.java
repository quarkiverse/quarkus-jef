...
public enum TemperatureOversampling {
    ...
    LOW_POWER(Oversampling.BMP280_OVERSAMP_1X),
    STANDARD(Oversampling.BMP280_OVERSAMP_1X),
    HIGH(Oversampling.BMP280_OVERSAMP_1X),
    ULTRA_HIGH(Oversampling.BMP280_OVERSAMP_2X);
