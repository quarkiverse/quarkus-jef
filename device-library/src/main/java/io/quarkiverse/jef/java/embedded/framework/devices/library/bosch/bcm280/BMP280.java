package io.quarkiverse.jef.java.embedded.framework.devices.library.bosch.bcm280;

import static io.quarkiverse.jef.java.embedded.framework.devices.library.bosch.bcm280.Register.*;

import java.io.IOException;

import io.quarkiverse.jef.java.embedded.framework.devices.library.core.DeviceImpl;
import io.quarkiverse.jef.java.embedded.framework.devices.library.core.ReadProperty;
import io.quarkiverse.jef.java.embedded.framework.devices.library.core.WriteProperty;
 ...
 * Datasheet for this sensor available at
 * <a href="https://www.bosch-sensortec.com/media/boschsensortec/downloads/datasheets/bst-bmp280-ds001.pdf">here</a>
 */
...
public class BMP280 extends DeviceImpl {
    ...
    public void setSpi3w(boolean enabled) throws IOException {
        int config = getConfig();
        setConfig(
                enabled ? config | 0b00000001 : config & 0b00000001);
    }
    ...
    private double getTemperatureC(long adc_T) {
        ...
        double var2 = ((((double) adc_T) / 131072.0 - ((double) calibrationData.getT1()) / 8192.0) *
                (((double) adc_T) / 131072.0 - ((double) calibrationData.getT1()) / 8192.0))
                * ((double) calibrationData.getT3());
    ...
    public static final class BMP280CalibrationData {
        ...
        public BMP280CalibrationData(int t1, int t2, int t3, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8,
                int p9) {
            T1 = t1;
            T2 = t2;
            T3 = t3;
