...
public enum PressureOversampling {
    SKIP(Oversampling.BMP280_OVERSAMP_SKIPPED),
    ULTRA_LOW_POWER(Oversampling.BMP280_OVERSAMP_1X),
    LOW_POWER(Oversampling.BMP280_OVERSAMP_2X),
    STANDARD(Oversampling.BMP280_OVERSAMP_4X),
    HIGH_RESOLUTION(Oversampling.BMP280_OVERSAMP_8X),
    ULTRA_HIGH(Oversampling.BMP280_OVERSAMP_16X);
