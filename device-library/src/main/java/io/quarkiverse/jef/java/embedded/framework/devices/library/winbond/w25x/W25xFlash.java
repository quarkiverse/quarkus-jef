package io.quarkiverse.jef.java.embedded.framework.devices.library.winbond.w25x;

import static io.quarkiverse.jef.java.embedded.framework.devices.library.winbond.w25x.W25XCommands.*;
import static io.quarkiverse.jef.java.embedded.framework.devices.library.winbond.w25x.W25XCommandsBuffers.*;
...
public class W25xFlash {
    ...
    private void readChipId(SpiBus bus) throws NativeIOException {
        ...
        chipID = String.format("%2h-%2h-%2h-%2h-%2h-%2h-%2h-%2h", buf.get() & 0xFF, buf.get() & 0xFF, buf.get() & 0xFF,
                buf.get() & 0xFF, buf.get() & 0xFF, buf.get() & 0xFF, buf.get() & 0xFF, buf.get() & 0xFF).toUpperCase();
