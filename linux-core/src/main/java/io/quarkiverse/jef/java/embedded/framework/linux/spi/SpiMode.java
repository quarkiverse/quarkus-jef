...
/**
 * Describes Clock polarity and phase of SPI bus @see
 * <a href="https://en.wikipedia.org/wiki/Serial_Peripheral_Interface#Clock_polarity_and_phase">Wikipedia</a>
 * In addition to setting the clock frequency, the master must also configure the clock polarity and phase with respect to the
 * data. Motorola SPI Block Guide[2] names these two options as CPOL and CPHA (for clock polarity and phase) respectively,
