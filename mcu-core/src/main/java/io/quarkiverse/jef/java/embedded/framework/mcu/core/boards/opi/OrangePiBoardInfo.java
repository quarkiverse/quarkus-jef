...
enum OrangePiBoardInfo {
    ...
    /**/ ORANGE_PI_R1("Orange Pi R1", "sun8i", "Allwinner H2+ quad core 256MB/512MB RAM SoC WiFi SPI 2xETH",
            Sun8i26PinBoard.class),
    ...
    /**/ ORANGE_PI_ZERO_PLUS_2("Orange Pi Zero Plus 2", "sun8i", "Allwinner H3 quad core 512MB RAM SoC Wi-Fi/BT",
            OrangePiZero2PlusBoard.class),

    /**/ ORANGE_PI_ZERO_PLUS("Orange Pi Zero Plus", "sun50iw2", "Allwinner H5 quad core 512MB RAM SoC GBE WiFi SPI",
            Sun8i26PinBoard.class), // Xunlong Orange Pi Zero same pinout
    ...
    /**/ ORANGE_PI_ZERO_PLUS_2A("Orange Pi Zero Plus 2", "sun50iw2", "Allwinner H5 quad core 512MB RAM SoC Wi-Fi/BT",
            OrangePiZero2PlusBoard.class),
    ...
    /**/ ORANGE_PI_LITE_2("Orange Pi Lite 2", "sun50iw6", "Allwinner H6 quad core 1GB RAM SoC WiFi USB3",
            OrangePiLight2Board.class),

    /**/ ORANGE_PI_ONE_PLUS("Orange Pi One+", "sun50iw6", "Allwinner H6 quad core 1GB RAM SoC GBE", OrangePiLight2Board.class),
    /**/ ORANGE_PI_WIN("Orange Pi Win", "sun50iw1", "Allwinner A64 quad core 1GB/2GB RAM SoC GBE WiFi/BT",
            OrangePiWinBoard.class),
    /**/ ORANGE_PI_ZERO_2("Orange Pi Zero2", "sun50iw6", "Allwinner H616 quad core 512MB/1GB RAM SoC WiFi SPI USB-C",
            OrangePiZero2Board.class),
